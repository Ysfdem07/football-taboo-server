      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.topBar}>
          ...
          <View style={{ flexDirection: 'row', gap: 10 }}>
            <TouchableOpacity style={[styles.iconButton, { borderColor: '#FFD700' }]} onPress={() => navigation.navigate('CardAlbum', {})}>
        ...
        <View style={styles.bottomBar}>
          ...
          <TouchableOpacity style={styles.tabItem} onPress={() => navigation.navigate('CardAlbum', {})}>
